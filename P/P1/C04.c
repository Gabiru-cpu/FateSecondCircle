...
//usou vetor para pegar 1 char na pesquisa por 1 char
//nao usou a funcao 3(pesquisa nome) nas funcoes altera e exclui
//pergunta em cada opcao de menu????
//exclui apaga o arquivo e nao funciona
